...
| [whatsapp](./whatsapp) | `TOKEN` (Bearer) | 70 em 5 serviços | 70 recursos importados e conferidos; conta com token temporário, falta trocar pelo permanente e validar em diagrama |
